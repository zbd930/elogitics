...
public class details {
        ...
        private java.util.Date kill_start;
        private java.util.Date kill_end;
        private Ship ship;
    ...
    public java.util.Date getKill_start() {
        return kill_start;
    }

    public void setKill_start(java.util.Date kill_start) {
        this.kill_start = kill_start;
    }

    public java.util.Date getKill_end() {
        return kill_end;
    }

    public void setKill_end(java.util.Date kill_end) {
